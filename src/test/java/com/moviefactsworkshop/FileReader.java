...
public class FileReader {
    ...
    public static void main(String[] args) {
        ...
        fileReader.loadMovies();
        Random ran = new Random();
        System.out.println(fileReader.allMovies.size());
        int run = 0;
        while (run < 10){
            int random = ran.nextInt(fileReader.allMovies.size());
            System.out.println(fileReader.allMovies.get(random).getTitle());
            run ++;
        }
